...
class Controllers:
    def __init__(self):
        ...
        for i in range(0, 12):
            if i<6:
                self._servos.append(servo.Servo(self._pca_1.channels[i], min_pulse=771, max_pulse=2740))    # MG996R pulse
            else:
                self._servos.append(servo.Servo(self._pca_2.channels[i], min_pulse=771, max_pulse=2740))    # MG996R pulse
